...
> 新批次为五项视觉结构（ModeBank/CentreTilt/BlockMetric/ContrastMetric/SoftEnergy）
> 加两项外部文本扩展（TextMetric/TextSubspace），均config-ready，无结果。
...
结构；五个视觉结构不增加外部信息，两个冻结文本扩展经用户授权另列，均未测。
