...
> route-fastmem **47.49（-1.00）**，均相对route48.49暂按best口径比较。owner-reported，
> best/last、完成状态及运行日志待核验。保留原n0初值200、EMA新信息比例.01；停止扩展
> 这轮参数搜索，不因慢臂在三个负结果中最高而认定慢更新有效。下一步先核验赢家与本批
> 日志，不自动排更密网格或组合。交付提交6590b23，详见EXPERIMENTS.md §7.15。
>
...
2026-09-09新增：§7.15三项47.40/47.84/47.49的best/last、对应迭代、完成状态、实际
seed/SHA与完整日志，以及末段n0/lambda/mix/route_move；交付SHA不能替代实际训练SHA。
