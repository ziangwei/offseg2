...
CONFIG="${CONFIG:-local_configs/offseg2/Base/parseglcr_post40k_from160k_ade20k-512x512.py}"
CKPT="${CKPT:-work_dirs/parseglcr_ade20k_160k-512x512_4x4_try1/iter_160000.pth}"
WORK_DIR="${WORK_DIR:-work_dirs/parseglcr_post40k_from160k_ade20k-512x512_4x4_try1}"
