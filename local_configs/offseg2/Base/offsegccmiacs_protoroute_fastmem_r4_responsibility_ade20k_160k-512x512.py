...
# Fast bank updates: absorb 10% of each eligible batch mean, instead of 1%.
...
model = dict(decode_head=dict(proto_momentum=0.1))
load_from = None
resume = False
work_dir = './work_dirs/offsegccmiacs_protoroute_fastmem_r4_responsibility_ade20k_160k-512x512'
