...
model = dict(decode_head=dict(type='OffSegCCMIACSProtoRouteBlockMetric'))
work_dir = './work_dirs/offsegccmiacs_protoroute_blockmetric_b_r4_responsibility_ade20k_160k-512x512'
