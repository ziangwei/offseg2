...
model = dict(decode_head=dict(type='OffSegCCMIACSProtoRouteRecollect'))
work_dir = './work_dirs/offsegccmiacs_protoroute_recollect_b_r4_responsibility_ade20k_160k-512x512'
