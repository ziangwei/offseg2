# PARSeg-LCR warm-start finetune gate.
#
# Load the PARSeg3 48.2 checkpoint and keep the whole head trainable. This tests
# whether local candidate-relation ranking can improve the tuned decision
