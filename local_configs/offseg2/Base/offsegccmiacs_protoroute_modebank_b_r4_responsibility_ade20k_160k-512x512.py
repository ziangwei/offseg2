...
model = dict(decode_head=dict(type='OffSegCCMIACSProtoRouteModeBank'))
work_dir = './work_dirs/offsegccmiacs_protoroute_modebank_b_r4_responsibility_ade20k_160k-512x512'
