...
# late-stage optimizer and scheduler state.
...
optim_wrapper = dict(
    _delete_=True,
    type='OptimWrapper',
    optimizer=dict(type='AdamW', lr=0.000001, betas=(0.9, 0.999), weight_decay=0.01),
...
param_scheduler = [
    dict(type='PolyLR', eta_min=1e-8, power=1.0, begin=0, end=max_iters, by_epoch=False),
]
default_hooks = dict(
